...
(deffacts conjuntos_difusos
	...
	(cd dosis alta 8 9 9 10)     ; aproximadamente 9


	; Nueva variable: Edad

	(cd edad joven 0 0 12 18)	 ; aproximadamente menos de 12
	(cd edad adulto 16 18 50 60) ; aproximadamente entre 18 y 50
	(cd edad anciano 55 60 150 150)	; aproximadamente mas de 60 
)
...
(deffacts reglas
	...
	; Nuevas reglas: Disminuimos las dosis para jovenes y ancianos

	(regla 5 antecedente edad joven)
	(regla 5 antecedente temperatura destemplada)
	(regla 5 consecuente dosis baja)
	(regla 5 explicacion "Si es joven y esta destemplado, la dosis a aplicar es baja")
	(regla 6 antecedente edad joven)
	(regla 6 antecedente temperatura alta)
	(regla 6 consecuente dosis media)
	(regla 6 explicacion "Si es joven y la temperatura es alta, la dosis a aplicar es media")
	(regla 7 antecedente edad anciano)
	(regla 7 antecedente temperatura destemplada)
	(regla 7 consecuente dosis baja)
	(regla 7 explicacion "Si es anciano y esta destemplado, la dosis a aplicar es baja")
	(regla 8 antecedente edad anciano)
	(regla 8 antecedente temperatura alta)
	(regla 8 consecuente dosis media)
	(regla 8 explicacion "Si es anciano y la temperatura es alta, la dosis a aplicar es media")
)
